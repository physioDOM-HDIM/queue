...
function Queue( config ) {
							...
							request( {
									...
									if( err || resp.statusCode === 500) {
										...
										if( resp.statusCode === 400 ) {
											...
											returnStatus( msg.server, msg.subject, false );
										} else {
											returnStatus( msg.server, msg.subject, true );
										}
	...
	function returnStatus( server, subject, status ) {
		logger.trace("returnStatus", { subject:subject, status:status } );
		request( {
